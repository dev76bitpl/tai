...
- [x] `CLAUDE.md` 3d — korekta: 404 na istniejącej trasie to katalog budowania, nie adres bazowy;
      przy okazji zasada „zmieniaj jedną rzecz na raz, inaczej nie zapisuj przyczyny w regułach"
